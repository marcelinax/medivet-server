...
export class MedivetClinicAssignmentRequestsController {
    ...
    @ApiOperation({
        summary: 'Sends request to confirm assignment',
    })
    @ApiOkResponse({
    ...
    @ApiOperation({
        summary: 'Sends request to confirm unassignment',
    })
    @ApiOkResponse({
        description: 'Request has been sent',
        type: OkMessageDto
    ...
    @ApiOperation({
        summary: 'Rejects clinic assignment',
    })
    @ApiOkResponse({
    ...
    @ApiOperation({
        summary: 'Rejects clinic unassignment',
    })
    @ApiOkResponse({
        description: 'Request has been rejected',
        type: OkMessageDto
    ...
    async getAllClinicAssignmentRequests(
        ...
        return this.clinicAssignmentRequestsService.searchClinicRequestAssignments({ pageSize, offset });
    }
